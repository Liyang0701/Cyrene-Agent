...
// sticker manager window
  ...
  CHANNELS_WECHAT_LOGIN_REFRESH: "channels:wechat:login-refresh",
  CHANNELS_WECHAT_LOGIN_STATE: "channels:wechat:login-state",
  ...
  CHANNELS_WECHAT_ACCOUNTS_LIST: "channels:wechat:accounts-list",
  CHANNELS_WECHAT_ACCOUNT_RENAME: "channels:wechat:account-rename",
  CHANNELS_WECHAT_ACCOUNT_SET_ENABLED: "channels:wechat:account-set-enabled",
  CHANNELS_WECHAT_ACCOUNT_RECONNECT: "channels:wechat:account-reconnect",
  CHANNELS_WECHAT_ACCOUNT_RESCAN: "channels:wechat:account-rescan",
  CHANNELS_WECHAT_ACCOUNT_DELETE: "channels:wechat:account-delete",
