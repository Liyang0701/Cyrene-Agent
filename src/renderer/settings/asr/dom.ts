...
export const asrLocalRootInput = document.getElementById("asr-local-root") as HTMLInputElement | null;
export const asrLocalModelPathInput = document.getElementById("asr-local-model-path") as HTMLInputElement | null;
export const asrLocalSystemPromptInput = document.getElementById("asr-local-system-prompt") as HTMLInputElement | null;
export const asrLocalStatus = document.getElementById("asr-local-status");
export const asrLocalTestButton = document.getElementById("asr-local-test") as HTMLButtonElement | null;
