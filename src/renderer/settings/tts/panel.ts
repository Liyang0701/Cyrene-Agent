...
async function loadTtsConfig(): Promise<void> {
  ...
  (ttsEl("tts-gptsovits-prompt-lang") as HTMLSelectElement).value = String(ttsState.config.ttsGptsovitsPromptLang ?? "zh");
  (ttsEl("tts-gptsovits-text-lang") as HTMLSelectElement).value = String(ttsState.config.ttsGptsovitsTextLang ?? "zh");
