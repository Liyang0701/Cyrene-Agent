...
import type {
  ArchivedCharacterStateView,
  CharacterReplacementView,
  CharacterSettingsSnapshot,
} from "../character-settings-view";
import type { WechatAccountSettingsViewItem } from "../wechat-account-settings-view";
...
export interface MobileCallPairingView {
  callId: string;
  roomName: string;
  expiresAt: string;
  qrDataUrl: string;
...
export interface WechatLoginSessionView {
...
export interface SettingsApi {
  ...
  reviewDevicePairing?: (challengeId: string) => Promise<DesktopPairingReviewDisplay>;
  decideDevicePairing?: (
    challengeId: string,
    allow: boolean,
